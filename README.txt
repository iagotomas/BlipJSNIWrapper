...
The success of this command should create a .jar file in the target folder (target/BlipJSNIWrapper-version.jar)
...
(target/BlipJSNIWrapper-version/gwt_blip)
...
the following statement:
	...
	<inherits name="com.sinewavemultimedia.Blip"/>
